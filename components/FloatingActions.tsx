...
export default function FloatingActions() {
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-zinc-200 bg-white pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_30px_rgba(15,23,42,0.12)] md:hidden">
        <Link
          href="/contact"
          className="flex flex-1 items-center justify-center bg-[#f0571f] px-4 py-3.5 text-sm font-bold text-white touch-manipulation"
        >
          Contact Us
        </Link>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-1 items-center justify-center gap-2 px-4 py-3.5 text-sm font-bold text-[#111827] touch-manipulation"
        >
